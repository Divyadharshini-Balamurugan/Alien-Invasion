...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Separate Window for game
        # self.screen = pygame.display.set_mode((self.settings.screen_width,self.settings.screen_height))
        pygame.display.set_caption("Alien Invasion")

        # Create an instance to store game statistcs and create a scoreboard.
    ...
    def _update_screen(self):
                ...
                # Draw the play button if the game is inacive.
